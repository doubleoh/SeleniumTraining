...
public class Task6 {
	...
	public void test() throws InterruptedException {
		...
		driver.findElement(By.cssSelector("input[name='new_images[]']"))
				.sendKeys("C:\\Users\\andrii.omelchuk\\Desktop\\disco-duck.jpg");
		...
		wait.until(ExpectedConditions.attributeContains(driver.findElement(By.cssSelector("body > div > div > div > table > tbody > tr > td:nth-child(3) > form > table > tbody > tr:nth-child(4) > td:nth-child(3) > a")), "textContent", "Disco Duck"));
	}
